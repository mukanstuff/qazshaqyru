...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const description =
    locale === 'kz'
      ? 'Шақыруды жасау мен түзету тегін. Жариялау — таңдаған үлгі бағасын бір рет төлеу: сервис белгісіз, қонақ функциялары, тойханаға тізім. Төлем Kaspi арқылы.'
      : 'Создание и редактирование приглашения — бесплатно. Публикация — разовая оплата цены выбранного шаблона: полный доступ, все функции для гостей, список для тойханы. Оплата через Kaspi.';
  return {
    title,
    description,
    ...
    <PublicShell isLoggedIn={Boolean(session)}>
      <JsonLd
        data={buildServiceSchema({
          ...
          description:
            locale === 'kz'
              ? 'Онлайн шақырулар: қонақ жауабы, тізім, отырғызу, тойханаға файл. Жариялау — үлгі бағасын бір рет төлеу.'
              : 'Онлайн-приглашения: ответы гостей, список, рассадка, файл для тойханы. Публикация — разовая оплата цены шаблона.',
          path: '/pricing',
        })}
      />
      ...
      <div className="border-b border-us-border bg-us-ivory/40 py-10">
        <div className="mx-auto max-w-3xl px-4 text-center">
          ...
          <p className="mt-4 font-body text-sm text-us-ink-muted md:text-base">
            {locale === 'kz'
              ? 'Шақыруды жасау мен түзету тегін. Жариялау — таңдаған үлгі бағасын бір рет төлеу: сервис белгісіз сілтеме, қонақтар тізімі, ресторанға файл.'
              : 'Создание и редактирование приглашения — бесплатно. Публикация — разовая оплата цены выбранного шаблона: рабочая ссылка, список гостей, файл для ресторана.'}
          </p>
        </div>
      </div>

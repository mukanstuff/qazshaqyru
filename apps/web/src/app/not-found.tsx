...
// Client component so it can read the visitor's locale. This page was written
// in hardcoded Russian while its sibling error.tsx used t() — a Kazakh visitor
// who mistyped a URL got a Russian dead end.
  ...
  return (
    <PublicShell>
      <div className="us-container relative flex min-h-[62vh] flex-col items-center justify-center overflow-hidden py-16 text-center">
        ...
        <h1 className="font-display text-3xl text-us-ink md:text-4xl">{t('errors.notFoundTitle')}</h1>
        ...
        <div className="mt-8 flex w-full max-w-xs flex-col items-stretch gap-3 sm:max-w-none sm:flex-row sm:flex-wrap sm:items-center sm:justify-center">
          ...
          <Button variant="outline" asChild>
            <Link href="/templates">{t('errors.goTemplates')}</Link>
          </Button>
        </div>
      </div>
    </PublicShell>

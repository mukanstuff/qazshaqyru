...
export const T = {
  ru: {
    ...
    programLook: 'Вид программы',
    programList: 'Список',
    programRail: 'Линия с иконками',
    programStack: 'По центру',
    programZigzag: 'Зигзаг',
    timeFont: 'Шрифт времени',
  ...
  kz: {
    ...
    slug: 'Slug',
    addItem: 'Тармақ қосу',
    programLook: 'Бағдарлама көрінісі',
    programList: 'Тізім',
    programRail: 'Иконкалы сызық',
    programStack: 'Ортасында',
    programZigzag: 'Зигзаг',
    timeFont: 'Уақыт қарпі',

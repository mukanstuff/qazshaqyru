...
export function buildSoftwareApplicationSchema() {
  return {
    ...
    offers: {
      ...
      price: '2990',
      priceCurrency: 'KZT',
      description: 'Создание, редактирование и публикация приглашения бесплатны; разовая оплата цены выбранного шаблона убирает логотип сервиса и открывает все функции для гостей',
    },
    url: getSiteOrigin(),
    provider: { '@id': orgId() },
  };

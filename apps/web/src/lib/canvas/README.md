...
6. Добавить пункт в палитру (`ElementPalette.tsx`) и секцию в `components/canvas/inspector/XxxSection.tsx`, подключив её в `PropertiesPanel.tsx`.
...
- Реализованы все 10 этапов по техническому заданию (v2):
  ...
  8. Пресеты палитр, шрифтовых пар и фонов — вкладка «Дизайн» в quick-edit sheet (`EditorSheetTabDesign.tsx`), применяются в один клик.

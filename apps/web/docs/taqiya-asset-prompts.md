...
| `envelope` | **принят владельцем.** Поля сверху и снизу, 44% высоты под конвертом, ему не мешают, а под надписи даже удобны; дотягивать конверт до краёв не нужно. Известный изъян: печать трескается на клапане, а под ней видна вторая, целая — при сборке растворение начинать с момента трещины |
